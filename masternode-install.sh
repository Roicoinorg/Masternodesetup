...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='roicoin.conf'
CONFIGFOLDER='/root/.roicoin'
COIN_DAEMON='roicoind'
COIN_CLI='roicoin-cli'
COIN_TX='roicoin-tx'
COIN_PATH='/usr/local/bin/'
OS_VERSION=$(lsb_release -d)
COIN_TGZP='https://github.com/Roicoinorg/Roicoinorg/releases/download/1000/roicoin-linux-daemon1000.zip'
https://github.com/Roicoinorg/Roicoinorg/releases/download/1000/roicoin-linux-daemon1000.zip
COIN_BOOTSTRAP='https://github.com/Roicoinorg/Roicoinorg/releases/download/1000/bootstrap.zip'
COIN_BOOTSTRAP_NAME=$(echo $COIN_BOOTSTRAP | awk -F'/' '{print $NF}')
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='roicoin'
COIN_NAME_OLD='roicoind'
PROJECT_NAME='Roicoin (roi)'
COIN_EXPLORER='https://roi.cryptoscope.io/'
COIN_PORT=6552
RPC_PORT=6551
...
cat << EOF > /root/roicoin-general-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME General Info: ${NC}"
$COIN_CLI getinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/roicoin-general-info

cat << EOF > /root/roicoin-fee-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Fee Info: ${NC}"
$COIN_CLI getfeeinfo 100
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/roicoin-fee-info

cat << EOF > /root/roicoin-networkinfo
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Network Info: ${NC}"
$COIN_CLI getnetworkinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/roicoin-networkinfo

cat << EOF > /root/roicoin-masternode-stats
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
...
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/roicoin-masternode-stats

cp /root/.bashrc /root/.bashrc.backup
sed '/feestats/d' /root/.bashrc | sed '/networkstats/d' | sed '/mnstats/d' | sed '/roicoininfo/d' > /root/tmp
mv /root/tmp /root/.bashrc
echo -e "alias feestats='/root/roicoin-fee-info'" >> /root/.bashrc
echo -e "alias networkstats='/root/roicoin-networkinfo'" >> /root/.bashrc
echo -e "alias mnstats='/root/roicoin-masternode-stats'" >> /root/.bashrc
exec bash
}
...
function important_information() {
 ...
 echo -e "You can also use ${RED}roicoin-cli getinfo${NC}, ${RED}roicoin-cli getblockcount${NC}, ${RED}roicoin-cli getmasternodewinners${NC} and ${RED}roicoin-cli getblockchaininfo${NC} commands for a nice looking infos.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
